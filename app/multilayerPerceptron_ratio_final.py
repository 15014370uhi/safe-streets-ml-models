...
for record in sectors:
    ...
    start = timeit.default_timer()
    classifier = make_pipeline(StandardScaler(), MLPClassifier(solver='adam', max_iter=300, alpha=1e-05, hidden_layer_sizes=(6,5), random_state=1))     
   ...
   # Make predictions for the test set
    ...
    #testing prediciton of probability
    ...
    #save model to file    
    filename = 'MultiLayerPerceptron_Ratios/MultiLayerPerceptron_' + record['sector'] + '.sav'  
